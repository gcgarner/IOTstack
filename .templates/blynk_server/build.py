...
buildMenus = {} # Options, and potentially others
haltOnErrors = True
...
def main():
  ...
  global buildMenus # Where to place the options menu result
  ...
  def checkForMenu():
    try:
      buildMenus["options"] = callable(runOptionsMenu)
    except:
      buildMenus["options"] = False
      return buildMenus
    return buildMenus
