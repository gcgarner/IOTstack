...
def main():
  ...
  def preBuild():
    ...
    # Files copy
    shutil.copy(r'%s/timescaledb.env' % serviceTemplate, r'%s/timescaledb.env' % serviceService)
    return True
...
global currentServiceName # Name of the current service
if currentServiceName == 'timescaledb':
  main()
else:
  print("Error. '{}' Tried to run 'timescaledb' config".format(currentServiceName))
